...
router.get('/',checkLoginUser, async function(req, res, next) {
    ...
    const records = await passCatModule.find({}).exec(function(err,data){
      if(err) throw err;
  ...
  router.get('/edit/:id', function(req, res, next) {
    ...
    var getPassCategory=passCatModule.findById(passCatId);
    getPassCategory.exec(function(err,data){
      if(err) throw err;
      res.render('editPassCategory', { title: 'Password Management System',LoginUser:LoginUser,errors:'',success:'',records:data,id:passCatId});  
    })
  });
 ...
 router.post("/password-details/edit/", function (req, res, next) {
    var LoginUser = localStorage.getItem("LoginUser");
    var passCatId = req.body.id;
    var passwordCategory = req.body.passwordCategory;
    var update_passCat = passCatModule.findByIdAndUpdate(passCatId, {
  ...
  router.get("/password-details/delete/:id", function (req, res, next) {
    var LoginUser = localStorage.getItem("LoginUser");
    var id = req.params.id;
